...
'Opers_refs_summ' =>
 "User_ID int(11) NOT NULL,
  ...
  Sum decimal(12,5) default 0,
  SumUSD decimal(12,5) default 0,
  SumEUR decimal(12,5) default 0,
  SumRUB decimal(12,5) default 0,
  SumBTC decimal(10,5) default 0,
...
'Users' =>
 "uID int(10) NOT NULL auto_increment,
  ...
  uBal decimal(12,5) default 0,
  uBalUSD decimal(12,5) default 0,
  uBalEUR decimal(12,5) default 0,
  uBalRUB decimal(12,5) default 0,
  uBalBTC decimal(10,5) default 0,
  uLock decimal(12,5) default 0,
  uLockUSD decimal(12,5) default 0,
  uLockEUR decimal(12,5) default 0,
  uLockRUB decimal(12,5) default 0,
  uLockBTC decimal(10,5) default 0,
  uOut decimal(12,5) default 0,
  uOutUSD decimal(12,5) default 0,
  uOutEUR decimal(12,5) default 0,
  uOutRUB decimal(12,5) default 0,
  uOutBTC decimal(10,5) default 0,
  uLTS bigint(14),
  uLIP varchar(15),
  uLSess varchar(32),
  ...
  uSumDepo decimal(12,5) default 0,
  uSumDepoUSD decimal(12,5) default 0,
  uSumDepoEUR decimal(12,5) default 0,
  uSumDepoRUB decimal(12,5) default 0,
  uSumDepoBTC decimal(10,5) default 0,
  PRIMARY KEY  (uID),
...
'Currs' => // CID - Currency ID (see psys.php) -> Name, Curr
 "cID int(2) NOT NULL auto_increment,
  ...
  cCASHINMin decimal(9,2) default 0.00,
  cCASHINMax decimal(9,2) default 0.00,
  ...
  cCASHOUTMin decimal(9,2) default 0.00,
  cCASHOUTMax decimal(9,2) default 0.00,
  ...
  cCASHOUTLimit decimal(6,2) default 0.00,
  cTRMode int(1) default 0,
  cTRMin decimal(9,2) default 0.00,
  cTRMax decimal(9,2) default 0.00,
...
'Opers' =>
 "oID int(10) NOT NULL auto_increment,
  ...
  oSum decimal(12,5) default 0.0,
  oSum2 decimal(12,5) default 0.0,
  oSumReal DECIMAL(12,5) NOT NULL,
  oComis decimal(12,5) default 0.0,
  oParams text,
  oParams2 text,
  oBatch varchar(40),
  oTag varchar(60),
...
'Plans' =>
 "pID int(3) NOT NULL auto_increment,
  ...
  pMin decimal(12,5) default 1.00,
  pMax decimal(12,5) default 0.00,
  ...
  pMinAdd decimal(12,5) default 1.00,
  pDPerc text,
  pPPerc text,
...
'Deps' =>
 "dID int(10) NOT NULL auto_increment,
  ...
  dZ0 decimal(12,5) default 0.00,
  dZD decimal(12,5) default 0.00,
  dZDReal decimal(12,5) default 0.00,
  dCompnd decimal(7,2) default 0.00,
  dZC decimal(12,5) default 0.00,
  dNTS bigint(14) NOT NULL,
  dLTS bigint(14) NOT NULL,
  dZP decimal(12,5) default 0.00,
...
'Queue' =>
 "qID int(10) NOT NULL auto_increment,
  ...
  qPrice decimal(12,5) default 0.0,
